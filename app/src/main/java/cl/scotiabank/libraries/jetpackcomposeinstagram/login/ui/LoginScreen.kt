...
import cl.scotiabank.libraries.jetpackcomposeinstagram.R
...
fun Body(modifier: Modifier = Modifier, loginViewModel: LoginViewModel) {
    ...
    Column(modifier = modifier) {
        ...
        Spacer(modifier = Modifier.size(16.dp))
        LoginButton(loginEnable = isLoginEnable, loginViewModel = loginViewModel)
        Spacer(modifier = Modifier.size(16.dp))
        LoginDivider()
...
fun SocialLogin() {
    Row(
        ...
        Image(
            ...
            contentDescription = "Social media fb",
            modifier = Modifier.size(16.dp)
        )
        Text(
            text = "Continue as Lalin",
            fontSize = 14.sp,
            fontWeight = FontWeight.Bold,
            modifier = Modifier.padding(horizontal = 8.dp),
            color = Color(0xFF4EA8E9)
